        ...
        if name[0:3] == "sud":
            ...
            if await is_on_off(config.LOG):
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    f"{message.from_user.mention} لقد بدأت للتو التحقق من معلومات الأغنية  <code>𝐒𝐮𝐝𝐨𝐥𝐢𝐬𝐭</code>\n\n**𝐔𝐒𝐄𝐑 𝐈𝐃:-** {sender_id}\n**𝐍𝐀𝐌𝐄:-** {sender_name}",
                )
            return
        if name[0:3] == "lyr":
            ...
            if lyrics:
                ...
                return await message.reply_text(
                    "فشل في الحصول على كلمات الأغاني🥺 الرجاء المحاولة مرة أخرى 🥀."
                )
        if name[0:3] == "del":
...
☆............𝙱𝚈 » [Source soha](https://t.me/Mlze1bot)............☆"""
            key = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="🥀مطوري🥀", url="https://t.me/ASAKIOP"
                        ),
                        InlineKeyboardButton(
                            text="🏓𝐒𝐔𝐏𝐏𝐎𝐑𝐓🏓", url="https://t.me/Mlze1bot"
                        ),
                    ],
                ]
            )
        ...
        if await is_on_off(config.LOG):
            ...
            return await app.send_message(
                config.LOG_GROUP_ID,
                f"{message.from_user.mention}**تم دخول شخص جديد للبوت😍**.\n\n**𝐈𝐝:-** {sender_id}\n**𝐍𝐚𝐦𝐞:-** {sender_name}",
            )
